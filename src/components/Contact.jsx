    ...
    return (
        <div name='contact' className='w-full h-screen  flex justify-center items-center  pt-16 md:pt-10'>
            <form method='POST' action="https://getform.io/f/0cfcd49b-8ca5-494e-befe-b532b57ccecc" className='flex flex-col max-w-[600px] w-full mx-4'>
                ...
                <textarea name="message" placeholder='Message' rows="10" className='bg-gray-300 p-2'></textarea>
                <button className='text-white border-2 bg-[#a2d2ff] border-[#a2d2ff] hover:bg-[#56aeff] hover:border-[#56aeff] px-4 py-3 my-8 mx-auto flex items-center' >Let's Collaborate</button>
            </form >
