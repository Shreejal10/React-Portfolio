            ...
            <div className='hidden lg:flex fixed felx-col top-[30%] left-0'>
                <ul>
                    ...
                    <li className='w-[140px] h-[60px] flex justify-between items-center ml-[-90px] hover:ml-[-1px] duration-300 bg-[#6fc2b0]'>
                        <a className='flex justify-between items-center w-full text-gray-300 gap-2' href="https://user-images.githubusercontent.com/111437057/211320506-0320bd62-0c20-4d23-b908-bf5e67225709.png" target="_blank" rel="noopener noreferrer">
